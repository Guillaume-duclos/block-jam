...
const LevelViewer = memo(
  ({
    ...
    const score = useLevelStore(
      (state) => isFocused && state.getScore(difficulty, level)?.score
    );
            ...
            <Group transform={[{ translateY: yNumber }]}>
              ...
              <Group transform={[{ translateX: 4 }, { translateY: 72 - 20 }]}>
                <RoundedRect
                  ...
                  y={-2}
                  r={10}
                  width={levelViewerTextSize[level] + 4 || 0}
                  height={20}
                ...
                <RoundedRect
                  ...
                  y={0}
                  r={8}
                  width={levelViewerTextSize[level] || 0}
                  height={16}
                  color={colors.white}
                >
                  <Text
