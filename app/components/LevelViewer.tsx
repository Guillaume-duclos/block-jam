...
const LevelViewer = memo(
  ({ index, layout, locked, color }: Props): JSX.Element => {
        ...
        <GestureDetector gesture={panGesture}>
          <Canvas
            style={{
              ...
              boxShadow: `0px 0px 10px ${darken(color.primary, 0.4)}`,
            }}
          >
            <RoundedRect
              x={0}
            ...
            <Group transform={[{ translateY: yNumber }]}>
              ...
              >
                <RoundedRect
                  ...
                  color={darken(color.primary, 0.2)}
                />
              ...
              <Group transform={[{ translateX: 4 }, { translateY: 72 - 20 }]}>
                <RoundedRect
                  ...
                  height={20}
                  color={darken(color.primary, 0.25)}
                />
                ...
                >
                  <Text
                    ...
                    text={index}
                    font={font}
                    color={darken(color.primary, 0.45)}
                  />
                </RoundedRect>
              </Group>
            </Group>
